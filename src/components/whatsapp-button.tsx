...
export default function WhatsappButton() {
  return (
    ...
    >
      ...
      <div className="absolute right-0 w-0 opacity-0 pr-0 text-[1.2em] font-semibold text-white transition-all duration-300 group-hover:w-[70%] group-hover:opacity-100 group-hover:pr-[10px]">
        Connect
      </div>
    </motion.button>
  );
